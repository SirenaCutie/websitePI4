    ...
    <motion.div initial="initial" animate="animate">
      ...
      >
        ...
        >
          ...
          <motion.img
            className="img-fluid h-100 ms-auto d-none d-lg-block mt-5 ps-5"
            variants={screenImg}
            src={heroImage}
            alt="react logo"
          />
            ...
            <div className="me-lg-5">
              ...
              <div className="d-lg-flex align-items-start justify-content-between mt-5">
                <div className="d-grid gap-2">
                  <a
                    href="https://estgv.sharepoint.com/:f:/s/GrupoV-PI4/EvkYjixi9yRCvz95Cft6BPoBaTy0qyEN1biBJsEOvX6tlQ?e=wM5Njj"
                    className="btn btn-lg btn-primary text-white" target="_blank"
                  >
                    Descarregar
                  </a>
                </div>
        ...
        <div className="container my-4">
          <div className="row">
            ...
            <div className="col row row-cols-1 row-cols-md-2">
              ...
              <div className="col">
                <Card titulo="Vouchers" descricao={voucher} icon={iconvouc} />
              </div>

              <div className="col">
                <Card titulo="Reservas" descricao={reservas} icon={iconres} />
              </div>

              <div className="col">
                <Card titulo="QRCode" descricao={qr} icon={iconqr} />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-5 section-background-verde d-flex align-items-center">
        ...
        <div className="container py-5">
          <h1>
            <strong>Atualização das últimas versões da aplicação</strong>
          </h1>
            ...
            <div className="card-body p-4">
              <div className="accordion" id="accordionPanelsStayOpenExample">
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">{atualizacoes}</div>
                  </div>
                </div>
                <div className="accordion-item">
                  <h2
